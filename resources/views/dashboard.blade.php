            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                @php
                    $accesos = [
                        ...
                        ['conexiones.index', 'Conexiones', 'Tus conexiones y conversaciones.', 'M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4-.8L3 20l1.3-3.9A7.9 7.9 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'],
                    ...
                    if (Auth::user()->is_admin) {
                        $accesos[] = ['admin.dashboard', 'Admin', 'Moderación, usuarios y reportes.', 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'];
                    }
                @endphp
